                        ...
                        <div class="grid grid-cols-3 gap-4 mb-4">
                            <div>
                                ...
                                <select name="categoria" id="categoria" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                                    ...
                                    <option value="Cremosos" {{ old('categoria') == 'Cremosos' ? 'selected' : '' }}>Cremosos</option>
                                    <option value="Frutales" {{ old('categoria') == 'Frutales' ? 'selected' : '' }}>Frutales</option>
                                    <option value="Premium" {{ old('categoria') == 'Premium' ? 'selected' : '' }}>Premium</option>
                                    <option value="Individual" {{ old('categoria') == 'Individual' ? 'selected' : '' }}>Individual</option>
                                </select>
                            </div>
                            <div>
                            ...
                            <div>
                                ...
                                <input type="text" name="tamano" id="tamano" value="{{ old('tamano') }}" placeholder="Ej: 1L, 500ml"
                                       class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                            </div>
                        </div>
